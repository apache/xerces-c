...
public :
    enum Codes
    {
      ...
      , FACET_List_Null_baseValidator      = 210
      , FACET_Union_Null_memberTypeValidators   = 211
      , FACET_Union_Null_baseValidator     = 212
      , FACET_Union_invalid_baseValidatorType   = 213
      , VALUE_NotMatch_Pattern             = 214
      , VALUE_Not_Base64                   = 215
      , VALUE_Not_HexBin                   = 216
      , VALUE_GT_maxLen                    = 217
      , VALUE_LT_minLen                    = 218
      , VALUE_NE_Len                       = 219
      , VALUE_NotIn_Enumeration            = 220
      , VALUE_exceed_totalDigit            = 221
      , VALUE_exceed_fractDigit            = 222
      , VALUE_exceed_maxIncl               = 223
      , VALUE_exceed_maxExcl               = 224
      , VALUE_exceed_minIncl               = 225
      , VALUE_exceed_minExcl               = 226
      , VALUE_WS_replaced                  = 227
      , VALUE_WS_collapsed                 = 228
      , VALUE_Invalid_NCName               = 229
      , VALUE_ID_Not_Unique                = 230
      , VALUE_ENTITY_Invalid               = 231
      , VALUE_QName_Invalid                = 232
      , VALUE_NOTATION_Invalid             = 233
      , VALUE_no_match_memberType          = 234
      , VALUE_URI_Malformed                = 235
      , XMLNUM_emptyString                 = 236
      , XMLNUM_WSString                    = 237
      , XMLNUM_2ManyDecPoint               = 238
      , XMLNUM_Inv_chars                   = 239
      , XMLNUM_null_ptr                    = 240
      , XMLNUM_URI_Component_Empty         = 241
      , XMLNUM_URI_Component_for_GenURI_Only   = 242
      , XMLNUM_URI_Component_Invalid_EscapeSequence   = 243
      , XMLNUM_URI_Component_Invalid_Char   = 244
      , XMLNUM_URI_Component_Set_Null      = 245
      , XMLNUM_URI_Component_Not_Conformant   = 246
      , XMLNUM_URI_No_Scheme               = 247
      , XMLNUM_URI_NullHost                = 248
      , XMLNUM_URI_NullPath                = 249
      , XMLNUM_URI_Component_inPath        = 250
      , XMLNUM_URI_PortNo_Invalid          = 251
      , XMLNUM_DBL_FLT_maxNeg              = 252
      , XMLNUM_DBL_FLT_maxPos              = 253
      , XMLNUM_DBL_FLT_minNegPos           = 254
      , XMLNUM_DBL_FLT_InvalidType         = 255
      , XMLNUM_DBL_FLT_No_Exponent         = 256
      , Regex_Result_Not_Set               = 257
      , Regex_CompactRangesError           = 258
      , Regex_MergeRangesTypeMismatch      = 259
      , Regex_SubtractRangesError          = 260
      , Regex_IntersectRangesError         = 261
      , Regex_ComplementRangesInvalidArg   = 262
      , Regex_InvalidCategoryName          = 263
      , Regex_KeywordNotFound              = 264
      , Regex_BadRefNo                     = 265
      , Regex_UnknownOption                = 266
      , Regex_UnknownTokenType             = 267
      , Regex_RangeTokenGetError           = 268
      , Regex_NotSupported                 = 269
      , Regex_InvalidChildIndex            = 270
      , NEL_RepeatedCalls                  = 271
      , RethrowError                       = 272
      , Out_Of_Memory                      = 273
      , DV_InvalidOperation                = 274
      , E_HighBounds                       = 275
      , W_LowBounds                        = 276
      , W_HighBounds                       = 277
      , F_LowBounds                        = 278
