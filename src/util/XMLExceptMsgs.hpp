...
public :
    enum Codes
    {
      ...
      , Regex_Result_Not_Set               = 256
      , Regex_CompactRangesError           = 257
      , Regex_MergeRangesTypeMismatch      = 258
      , Regex_SubtractRangesError          = 259
      , Regex_IntersectRangesError         = 260
      , Regex_ComplementRangesInvalidArg   = 261
      , Regex_InvalidCategoryName          = 262
      , Regex_KeywordNotFound              = 263
      , Regex_BadRefNo                     = 264
      , Regex_UnknownOption                = 265
      , Regex_UnknownTokenType             = 266
      , Regex_RangeTokenGetError           = 267
      , Regex_NotSupported                 = 268
      , Regex_InvalidChildIndex            = 269
