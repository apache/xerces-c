...
public :
    enum Codes
    {
      ...
      , URL_MalformedURL                   = 88
      , URL_UnsupportedProto               = 89
      , URL_UnsupportedProto1              = 90
      , URL_OnlyLocalHost                  = 91
      , URL_NoProtocolPresent              = 92
      , URL_ExpectingTwoSlashes            = 93
      , URL_IncorrectEscapedCharRef        = 94
      , URL_UnterminatedHostComponent      = 95
      , URL_RelativeBaseURL                = 96
      , URL_BaseUnderflow                  = 97
      , Vector_BadIndex                    = 98
      , Val_InvalidElemId                  = 99
      , Val_CantHaveIntSS                  = 100
      , XMLRec_UnknownEncoding             = 101
      , E_HighBounds                       = 102
      , W_LowBounds                        = 103
      , W_HighBounds                       = 104
      , V_LowBounds                        = 105
