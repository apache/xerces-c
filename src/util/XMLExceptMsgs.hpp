...
public :
    enum Codes
    {
      ...
      , Regex_InvalidQuantifier            = 274
      , NEL_RepeatedCalls                  = 275
      , RethrowError                       = 276
      , Out_Of_Memory                      = 277
      , DV_InvalidOperation                = 278
      , XPath_NoAttrSelector               = 279
      , XPath_NoUnionAtStart               = 280
      , XPath_NoMultipleUnion              = 281
      , XPath_MissingAttr                  = 282
      , XPath_ExpectedToken1               = 283
      , XPath_PrefixNoURI                  = 284
      , XPath_NoDoubleColon                = 285
      , XPath_ExpectedStep1                = 286
      , XPath_ExpectedStep2                = 287
      , XPath_ExpectedStep3                = 288
      , XPath_NoForwardSlash               = 289
      , XPath_NoDoubleForwardSlash         = 290
      , XPath_NoForwardSlashAtStart        = 291
      , XPath_NoSelectionOfRoot            = 292
      , XPath_EmptyExpr                    = 293
      , XPath_NoUnionAtEnd                 = 294
      , XPath_InvalidChar                  = 295
      , XPath_TokenNotSupported            = 296
      , XPath_FindSolution                 = 297
      , DateTime_Assert_Buffer_Fail        = 298
      , DateTime_dt_missingT               = 299
      , DateTime_gDay_invalid              = 300
      , DateTime_gMth_invalid              = 301
      , DateTime_gMthDay_invalid           = 302
      , DateTime_dur_Start_dashP           = 303
      , DateTime_dur_noP                   = 304
      , DateTime_dur_DashNotFirst          = 305
      , DateTime_dur_inv_b4T               = 306
      , DateTime_dur_NoTimeAfterT          = 307
      , DateTime_dur_NoElementAtAll        = 308
      , DateTime_date_incomplete           = 309
      , DateTime_date_invalid              = 310
      , DateTime_time_incomplete           = 311
      , DateTime_time_invalid              = 312
      , DateTime_ms_noDigit                = 313
      , DateTime_ym_incomplete             = 314
      , DateTime_ym_invalid                = 315
      , DateTime_year_tooShort             = 316
      , DateTime_year_leadingZero          = 317
      , DateTime_ym_noMonth                = 318
      , DateTime_tz_noUTCsign              = 319
      , DateTime_tz_stuffAfterZ            = 320
      , DateTime_tz_invalid                = 321
      , DateTime_year_zero                 = 322
      , DateTime_mth_invalid               = 323
      , DateTime_day_invalid               = 324
      , DateTime_hour_invalid              = 325
      , DateTime_min_invalid               = 326
      , DateTime_second_invalid            = 327
      , DateTime_tz_hh_invalid             = 328
      , PD_NSCompat1                       = 329
      , PD_OccurRangeE                     = 330
      , PD_NameTypeOK1                     = 331
      , PD_NameTypeOK2                     = 332
      ...
      , PD_NameTypeOK6                     = 336
      , PD_NameTypeOK7                     = 337
      , PD_RecurseAsIfGroup                = 338
      , PD_Recurse1                        = 339
      , PD_Recurse2                        = 340
      , PD_ForbiddenRes1                   = 341
      , PD_ForbiddenRes2                   = 342
      , PD_ForbiddenRes3                   = 343
      , PD_ForbiddenRes4                   = 344
      , PD_NSSubset1                       = 345
      , PD_NSSubset2                       = 346
      , PD_NSRecurseCheckCardinality1      = 347
      , PD_RecurseUnordered                = 348
      , PD_MapAndSum                       = 349
      , PD_InvalidContentType              = 350
      , E_HighBounds                       = 351
      , W_LowBounds                        = 352
      , W_HighBounds                       = 353
      , F_LowBounds                        = 354
