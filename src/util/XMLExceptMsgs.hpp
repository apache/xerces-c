...
public :
    enum Codes
    {
      ...
      , XMLNUM_emptyString                 = 212
      , XMLNUM_WSString                    = 213
      , XMLNUM_2ManyDecPoint               = 214
      , XMLNUM_Inv_chars                   = 215
      , XMLNUM_null_ptr                    = 216
      , Regex_Result_Not_Set               = 217
      , Regex_CompactRangesError           = 218
      , Regex_MergeRangesTypeMismatch      = 219
      , Regex_SubtractRangesError          = 220
      , Regex_IntersectRangesError         = 221
      , Regex_ComplementRangesInvalidArg   = 222
      , Regex_InvalidCategoryName          = 223
      , Regex_KeywordNotFound              = 224
      , Regex_BadRefNo                     = 225
      , Regex_UnknownOption                = 226
      , Regex_UnknownTokenType             = 227
      , Regex_RangeTokenGetError           = 228
      , Regex_NotSupported                 = 229
      , Regex_InvalidChildIndex            = 230
      , NEL_RepeatedCalls                  = 231
      , RethrowError                       = 232
      , E_HighBounds                       = 233
      , W_LowBounds                        = 234
      , W_HighBounds                       = 235
