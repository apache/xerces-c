...
public :
    enum Codes
    {
      ...
      , PD_NameTypeOK6                     = 344
      , PD_NameTypeOK7                     = 345
      , PD_RecurseAsIfGroup                = 346
      , PD_Recurse1                        = 347
      , PD_Recurse2                        = 348
      , PD_ForbiddenRes1                   = 349
      , PD_ForbiddenRes2                   = 350
      , PD_ForbiddenRes3                   = 351
      , PD_ForbiddenRes4                   = 352
      , PD_NSSubset1                       = 353
      , PD_NSSubset2                       = 354
      , PD_NSRecurseCheckCardinality1      = 355
      , PD_RecurseUnordered                = 356
      , PD_MapAndSum                       = 357
      , PD_InvalidContentType              = 358
      , NodeIDMap_GrowErr                  = 359
      , F_HighBounds                       = 360
      , E_LowBounds                        = 361
      , E_HighBounds                       = 362
    };
