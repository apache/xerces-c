...
public :
    enum Codes
    {
      ...
      , NEL_RepeatedCalls                  = 281
      , RethrowError                       = 282
      , Out_Of_Memory                      = 283
      , DV_InvalidOperation                = 284
      , XPath_NoAttrSelector               = 285
      , XPath_NoUnionAtStart               = 286
      , XPath_NoMultipleUnion              = 287
      , XPath_MissingAttr                  = 288
      , XPath_ExpectedToken1               = 289
      , XPath_PrefixNoURI                  = 290
      , XPath_NoDoubleColon                = 291
      , XPath_ExpectedStep1                = 292
      , XPath_ExpectedStep2                = 293
      , XPath_ExpectedStep3                = 294
      , XPath_NoForwardSlash               = 295
      , XPath_NoDoubleForwardSlash         = 296
      , XPath_NoForwardSlashAtStart        = 297
      , XPath_NoSelectionOfRoot            = 298
      , XPath_EmptyExpr                    = 299
      , XPath_NoUnionAtEnd                 = 300
      , XPath_InvalidChar                  = 301
      , XPath_TokenNotSupported            = 302
      , XPath_FindSolution                 = 303
      , DateTime_Assert_Buffer_Fail        = 304
      , DateTime_dt_missingT               = 305
      , DateTime_gDay_invalid              = 306
      , DateTime_gMth_invalid              = 307
      , DateTime_gMthDay_invalid           = 308
      , DateTime_dur_Start_dashP           = 309
      , DateTime_dur_noP                   = 310
      , DateTime_dur_DashNotFirst          = 311
      , DateTime_dur_inv_b4T               = 312
      , DateTime_dur_NoTimeAfterT          = 313
      , DateTime_dur_NoElementAtAll        = 314
      , DateTime_dur_inv_seconds           = 315
      , DateTime_date_incomplete           = 316
      , DateTime_date_invalid              = 317
      , DateTime_time_incomplete           = 318
      , DateTime_time_invalid              = 319
      , DateTime_ms_noDigit                = 320
      , DateTime_ym_incomplete             = 321
      , DateTime_ym_invalid                = 322
      , DateTime_year_tooShort             = 323
      , DateTime_year_leadingZero          = 324
      , DateTime_ym_noMonth                = 325
      , DateTime_tz_noUTCsign              = 326
      , DateTime_tz_stuffAfterZ            = 327
      , DateTime_tz_invalid                = 328
      , DateTime_year_zero                 = 329
      , DateTime_mth_invalid               = 330
      , DateTime_day_invalid               = 331
      , DateTime_hour_invalid              = 332
      , DateTime_min_invalid               = 333
      , DateTime_second_invalid            = 334
      , DateTime_tz_hh_invalid             = 335
      , PD_NSCompat1                       = 336
      , PD_OccurRangeE                     = 337
      , PD_NameTypeOK1                     = 338
      , PD_NameTypeOK2                     = 339
      ...
      , PD_NameTypeOK6                     = 343
      , PD_NameTypeOK7                     = 344
      , PD_RecurseAsIfGroup                = 345
      , PD_Recurse1                        = 346
      , PD_Recurse2                        = 347
      , PD_ForbiddenRes1                   = 348
      , PD_ForbiddenRes2                   = 349
      , PD_ForbiddenRes3                   = 350
      , PD_ForbiddenRes4                   = 351
      , PD_NSSubset1                       = 352
      , PD_NSSubset2                       = 353
      , PD_NSRecurseCheckCardinality1      = 354
      , PD_RecurseUnordered                = 355
      , PD_MapAndSum                       = 356
      , PD_InvalidContentType              = 357
      , NodeIDMap_GrowErr                  = 358
      , F_HighBounds                       = 359
      , E_LowBounds                        = 360
      , E_HighBounds                       = 361
    };
