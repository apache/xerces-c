...
public :
    enum Codes
    {
      ...
      , DateTime_dur_inv_seconds           = 314
      , DateTime_date_incomplete           = 315
      , DateTime_date_invalid              = 316
      , DateTime_time_incomplete           = 317
      , DateTime_time_invalid              = 318
      , DateTime_ms_noDigit                = 319
      , DateTime_ym_incomplete             = 320
      , DateTime_ym_invalid                = 321
      , DateTime_year_tooShort             = 322
      , DateTime_year_leadingZero          = 323
      , DateTime_ym_noMonth                = 324
      , DateTime_tz_noUTCsign              = 325
      , DateTime_tz_stuffAfterZ            = 326
      , DateTime_tz_invalid                = 327
      , DateTime_year_zero                 = 328
      , DateTime_mth_invalid               = 329
      , DateTime_day_invalid               = 330
      , DateTime_hour_invalid              = 331
      , DateTime_min_invalid               = 332
      , DateTime_second_invalid            = 333
      , DateTime_tz_hh_invalid             = 334
      , PD_NSCompat1                       = 335
      , PD_OccurRangeE                     = 336
      , PD_NameTypeOK1                     = 337
      , PD_NameTypeOK2                     = 338
      ...
      , PD_NameTypeOK6                     = 342
      , PD_NameTypeOK7                     = 343
      , PD_RecurseAsIfGroup                = 344
      , PD_Recurse1                        = 345
      , PD_Recurse2                        = 346
      , PD_ForbiddenRes1                   = 347
      , PD_ForbiddenRes2                   = 348
      , PD_ForbiddenRes3                   = 349
      , PD_ForbiddenRes4                   = 350
      , PD_NSSubset1                       = 351
      , PD_NSSubset2                       = 352
      , PD_NSRecurseCheckCardinality1      = 353
      , PD_RecurseUnordered                = 354
      , PD_MapAndSum                       = 355
      , PD_InvalidContentType              = 356
      , NodeIDMap_GrowErr                  = 357
      , F_HighBounds                       = 358
      , E_LowBounds                        = 359
      , E_HighBounds                       = 360
    };
