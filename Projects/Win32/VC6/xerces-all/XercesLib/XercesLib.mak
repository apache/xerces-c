...
"$(INTDIR)\Version.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\Version.res" /i "\cygwin\home\swhite\gareth-xer-c\src\xercesc\util\Platforms\Win32" /d "NDEBUG" $(SOURCE)
...
"$(INTDIR)\Version.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\Version.res" /i "\cygwin\home\swhite\gareth-xer-c\src\xercesc\util\Platforms\Win32" /d "_DEBUG" $(SOURCE)
